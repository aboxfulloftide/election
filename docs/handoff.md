...
The execution backlog for the national work is documented in `docs/national-execution-backlog.md`. The active batch is Kentucky completion plus the Georgia, North Carolina, Virginia, and Wisconsin 2020-2024 cohort.
