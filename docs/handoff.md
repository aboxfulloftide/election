...
1. Identify official Florida district and precinct geometry sources by year or redistricting cycle.
2. Add a geometry migration or file-based geometry manifest.
3. Link generated Florida summaries to geometry IDs or stable map-layer keys.
4. Generate Florida district/county drilldown bundles.
5. Add frontend state drilldown and contest selector support.
...
4. Frontend contest selector and Florida state drilldown after at least one of the above creates the data shape the UI should consume.
