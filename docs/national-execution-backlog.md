...
Use official structured archives first, then official canvass PDFs and scans. Preserve redistricting-cycle metadata, older district numbering, renamed counties, and source quality grades. The first ten-state cohort now has year-level official source records in `data/source-registry/` and a source note at `docs/sources/legacy-cohort-01.md`; its acquisition audit is at `docs/sources/legacy-acquisition-audit.md`. Repeatable parsers now generate Idaho 2014/2016/2018 and Delaware 2018 summaries. Idaho’s validated federal/Governor lanes and Delaware’s complete 2018 target lanes are imported; Illinois 2018 remains partial and source-identified because only one congressional district is staged. The wave inventory is `data/national-cohorts/legacy-2010-2018.json`; five parallel ten-state batches are in `data/national-cohorts/2010-2018-cohorts.json`, with status generated by `npm run legacy:status`.
