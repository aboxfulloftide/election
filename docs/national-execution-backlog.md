...
Use official structured archives first, then official canvass PDFs and scans. Preserve redistricting-cycle metadata, older district numbering, renamed counties, and source quality grades. The wave inventory is `data/national-cohorts/legacy-2010-2018.json`; five parallel ten-state batches are in `data/national-cohorts/2010-2018-cohorts.json`, with status generated by `npm run legacy:status`.

### 5. Backfill 2000-2008

Use official legacy archives where available. Use reputable compiled data only when official results cannot be recovered, with lower quality grades and original citations retained. The wave inventory is `data/national-cohorts/legacy-2000-2008.json`; five parallel ten-state batches are in `data/national-cohorts/2000-2008-cohorts.json`, and the first batch starts after the 2010-2018 parser/source pattern is established.
